...
// Scoring distribution: 5 excellent/good, 5 average, 5 poor — mirrors real seller catalog
const DEMO_SKUS = [
  // ── Хорошо оптимизированные (длинный заголовок + описание 500+ символов) ──
  {
    sku: '12345001',
    title: 'Кроссовки спортивные мужские для бега и тренировок, размер 42, цвет чёрный/белый',
    price: 3200, purchase: 1100,
    description: 'Профессиональные беговые кроссовки для мужчин, разработанные для длительных тренировок и ежедневного бега. Подошва из EVA-пены обеспечивает отличную амортизацию при ударе о поверхность, снижая нагрузку на суставы. Верх выполнен из дышащего сетчатого материала, который поддерживает комфортный микроклимат внутри обуви даже при интенсивных нагрузках. Усиленный задник надёжно фиксирует пятку и предотвращает скольжение стопы. Нескользящая рифлёная подошва обеспечивает хорошее сцепление с любым покрытием — асфальт, беговая дорожка, грунт. Размерная сетка стандартная, соответствует европейской. Рекомендуем выбирать ваш обычный размер. Подходят для бега, функциональных тренировок, ходьбы.',
  },
  {
    sku: '12345004',
    title: 'Рюкзак городской мужской/женский 30 литров для работы и прогулок, чёрный',
    price: 2100, purchase: 680,
    description: 'Вместительный городской рюкзак объёмом 30 литров — идеальный выбор для работы, учёбы и повседневных прогулок. Основное отделение вмещает ноутбук до 15.6 дюймов в специальном мягком кармане, документы формата А4, смену одежды. Отдельный фронтальный карман на молнии — для мелких аксессуаров: ключей, наушников, зарядки. Эргономичные регулируемые лямки с мягкой подкладкой снижают нагрузку на плечи при долгом ношении. Спинка с сетчатыми вставками обеспечивает вентиляцию. Материал: нейлон 600D, водоотталкивающая пропитка. Металлические замки на молниях долговечны. Боковые карманы для бутылки воды. Ручка для переноски в руке.',
  },
  {
    sku: '12345014',
    title: 'Коврик для йоги и фитнеса нескользящий 6мм, фиолетовый, 183х61 см, TPE',
    price: 1400, purchase: 420,
    description: 'Профессиональный коврик для йоги и фитнеса из экологичного материала TPE (термопластичный эластомер), который не содержит ПВХ и безопасен для здоровья. Толщина 6 мм обеспечивает достаточную амортизацию для суставов при занятиях на твёрдом полу. Двухсторонняя текстура с микроузором предотвращает скольжение как на полу, так и под ладонями даже при интенсивном потоотделении. Стандартный размер 183×61 см подходит для практики большинства асан. Вес 800 г — удобно носить в чехле на плечевом ремне. Легко чистится влажной тканью. Не впитывает запахи. Отличный выбор для хатха-йоги, пилатеса, растяжки и общего фитнеса.',
  },
  // ── Средние (заголовок нормальный, описание 200-400 символов) ────────────
  {
    sku: '12345007',
    title: 'Носки спортивные мужские 5 пар, размер 40-42, хлопок',
    price: 450, purchase: 120,
    description: 'Комплект из 5 пар спортивных носков из хлопка с добавлением синтетических волокон. Усиленная пятка и мысок продлевают срок службы. Махровая стелька обеспечивает мягкость и амортизацию. Резинка не пережимает голень. Подходят для занятий спортом и повседневной носки. Температурный режим стирки до 40°С.',
  },
  {
    sku: '12345009',
    title: 'Футболка беговая мужская с влагоотводом, размер XL',
    price: 1200, purchase: 380,
    description: 'Лёгкая беговая футболка из быстросохнущей ткани с функцией влагоотвода. Материал: 90% полиэстер, 10% эластан. Плоские швы не натирают кожу при движении. Свободный крой не стесняет движений. Подходит для бега, велоспорта, тренировок в зале.',
  },
  {
    sku: '12345013',
    title: 'Бутылка для воды спортивная 750мл с крышкой-клапаном',
    price: 720, purchase: 210,
    description: 'Спортивная бутылка из пищевого тритана, объём 750 мл. Клапанная крышка открывается одной рукой. BPA-free. Широкое горлышко для добавления льда. Подходит для зала, велосипеда, пешего туризма.',
  },
  // ── Плохие (короткий заголовок, нет описания) ────────────────────────────
  { sku: '12345002', title: 'Кроссовки мужские р.43',       price: 3200, purchase: 1100, description: '' },
  { sku: '12345003', title: 'Кроссовки женские р.38',        price: 2900, purchase: 950,  description: '' },
  { sku: '12345005', title: 'Рюкзак 30л серый',              price: 2100, purchase: 680,  description: '' },
  { sku: '12345006', title: 'Сумка поясная',                 price: 890,  purchase: 280,  description: '' },
  { sku: '12345008', title: 'Носки 5 пар р.43-45',           price: 450,  purchase: 120,  description: '' },
  { sku: '12345010', title: 'Футболка мужская L',            price: 1200, purchase: 380,  description: '' },
  { sku: '12345011', title: 'Шорты мужские M',               price: 980,  purchase: 300,  description: '' },
  { sku: '12345012', title: 'Перчатки для фитнеса S/M',      price: 650,  purchase: 190,  description: '' },
  { sku: '12345015', title: 'Коврик для йоги серый',         price: 1400, purchase: 420,  description: '' },
];
  ...
  try {
    ...
    for (const item of DEMO_SKUS) {
      for (const platform of ['wb', 'ozon']) {
        await client.query(
          `INSERT INTO user_catalog (user_id, platform, sku, title, purchase_price, description)
           VALUES ($1, $2, $3, $4, $5, $6) ON CONFLICT DO NOTHING`,
          [userId, platform, item.sku, item.title, item.purchase, item.description || null],
        );
      }
    }
