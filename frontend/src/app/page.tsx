...
const SCENARIOS = [
  ...
  { icon: '⭐', title: 'Ответы на отзывы',     desc: 'Персонализированный ответ за 5 секунд.',       price: '7,90 ₽',   tag: 'Коммуникация' },
  { icon: '📦', title: 'Прогноз остатков',     desc: 'Предупреждение об out-of-stock за 7–14 дней.', price: '9,90 ₽',   tag: 'Аналитика' },
  { icon: '🔍', title: 'SEO-аудит карточки',   desc: 'Ключевые слова, заполненность, улучшения.',    price: '12,90 ₽',  tag: 'Контент' },
  ...
  { icon: '🎬', title: 'Мульти-фото студия',   desc: 'Несколько ракурсов — AI создаёт 3D-вид.',      price: '150,00 ₽', tag: 'Изображения' },
  { icon: '🔎', title: 'Анализ ниши',          desc: 'Конкуренция, цены, точки входа по ключу.',     price: '9,90 ₽',   tag: 'Аналитика' },
];
