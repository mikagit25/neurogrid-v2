          ...
          <div className="prose prose-slate max-w-none space-y-6 text-slate-700">
            ...
            <section>
              ...
              <p>
                ...
                Обработка персональных данных осуществляется в соответствии с Законом Республики Беларусь
                от 07.05.2021 № 99-З «О защите персональных данных» и Федеральным законом РФ
            ...
            <section id="payment-partner">
              <h2 className="text-lg font-semibold text-slate-800 mb-2">8. Передача данных финансовым партнёрам</h2>
              <p className="text-sm mb-2">
                Для обработки платёжных транзакций Сервис передаёт данные следующему оператору:
              </p>
              <div className="bg-slate-50 rounded-lg p-4 text-sm space-y-1 mb-2">
                <p><strong>Оператор:</strong> WebPay / ОАО «Белинвестбанк»</p>
                <p><strong>Передаваемые данные:</strong> адрес электронной почты, сумма и назначение платежа, уникальный идентификатор заказа</p>
                <p><strong>Цель:</strong> авторизация и проведение безналичного платежа</p>
                <p><strong>Правовое основание (РБ):</strong> ст. 6 Закона РБ № 99-З «О защите персональных данных» — согласие субъекта персональных данных, полученное при регистрации</p>
                <p><strong>Правовое основание (РФ):</strong> ст. 6, ч. 1, п. 1 и п. 5 ФЗ-152 — согласие субъекта и исполнение договора</p>
              </div>
              <p className="text-sm">
                Передача данных иным третьим лицам в коммерческих или маркетинговых целях не осуществляется.
                Согласие на передачу данных финансовому партнёру фиксируется отдельным чекбоксом при регистрации
                с указанием даты и времени его предоставления.
                Вы вправе отозвать согласие, обратившись по адресу{' '}
                <a href="mailto:support@neurogrid.network" className="text-purple-600 hover:underline">support@neurogrid.network</a>.
                После отзыва проведение платёжных операций через Сервис станет недоступным.
              </p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-slate-800 mb-2">9. Контакты</h2>
              <p className="text-sm">
